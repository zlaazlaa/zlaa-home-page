...
*/
    ...
    y = function (a, c) {
      if (c)
        a: {
          ...
          c != g &&
            null != c &&
            q(d, a, { configurable: !0, writable: !0, value: c });
        }
    },
    z = function (a) {
      var c =
        "undefined" != typeof Symbol && Symbol.iterator && a[Symbol.iterator];
      return c ? c.call(a) : { next: n(a) };
    };
  y("Promise", function (a) {
    ...
    f.prototype.s = function () {
      ...
      var e = this,
        h = !1;
      return { resolve: b(this.M), reject: b(this.u) };
    };
    ...
    f.prototype.K = function () {
      ...
      "function" === typeof b
        ? (b = new b("unhandledrejection", { cancelable: !0 }))
        : "function" === typeof e
        ? (b = new e("unhandledrejection", { cancelable: !0 }))
        : ((b = x.document.createEvent("CustomEvent")),
    ...
    f.race = function (b) {
      return new f(function (e, h) {
        for (var k = z(b), l = k.next(); !l.done; l = k.next())
          d(l.value).l(e, h);
      });
    };
    f.all = function (b) {
  ...
  var A = this || self,
    ...
    C = function (a, c) {
      ...
      for (var g; a.length && (g = a.shift()); )
        a.length || void 0 === c
          ? (d = d[g] && d[g] !== Object.prototype[g] ? d[g] : (d[g] = {}))
          : (d[g] = c);
    },
    D = function (a, c) {
      function d() {}
      ...
      a.R = function (g, f, r) {
        for (
          var b = Array(arguments.length - 2), e = 2;
          e < arguments.length;
          e++
        )
          b[e - 2] = arguments[e];
  ...
  function F(a, c) {
    a = a.split("%s");
    for (var d = "", g = a.length - 1, f = 0; f < g; f++)
  ...
  var G = function (a, c, d) {
    if ("string" !== typeof a) {
      var g = [B(a), a],
        f = "Assertion failed";
      c
        ? ((f += ": " + c), (g = Array.prototype.slice.call(arguments, 2)))
        : (f += ": Expected string but got %s: %s.");
      throw new F("" + f, g || []);
    }
    return a;
  };
  function H(a, c) {
    var d,
      g = B(c);
    g = (d = "array" == g || ("object" == g && "number" == typeof c.length))
      ? c
      : arguments;
