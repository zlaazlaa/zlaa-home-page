  ...
  function x(a, b, c) {
    if (b)
      a: {
        ...
        null != b &&
          (a
            ? l(r, d, { configurable: !0, writable: !0, value: b })
            : b !== c &&
              (void 0 === u[d] &&
                ((a = (1e9 * Math.random()) >>> 0),
                (u[d] = p ? n.Symbol(d) : "$jscp$" + a + "$" + d)),
              l(h, u[d], { configurable: !0, writable: !0, value: b })));
      }
  }
  x(
    "Symbol",
    function (a) {
      ...
      function c(h, e) {
        this.g = h;
        l(this, "description", { configurable: !0, writable: !0, value: e });
      }
      if (a) return a;
  ...
  x(
    ...
    function (a) {
      ...
      b.prototype.j = function () {
        ...
        var f = this,
          k = !1;
        return { resolve: e(this.K), reject: e(this.l) };
      };
...
*/
  ...
  function Ja(a, b) {
    ...
    return H(function (d) {
      ...
      if (2 != d.g) return (c = d.i), d.return({ response: c[0], error: c[1] });
      d.s = 0;
      d.j = null;
      ...
      h &&
        ...
        a.g &&
          ...
          h.source.postMessage(
            JSON.stringify({ id: "sodar", params: a.i }),
  ...
  function Ta(a) {
    ...
    return H(function (g) {
      ...
      if (4 != g.g) {
        ...
        return E(g, Ja(a.j, { T: a.g.v, I: a.g.u, m: a.m }), 4);
      }
      d = g.i;
